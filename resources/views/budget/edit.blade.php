                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="name" name="name" placeholder="Masukan nama" value="{{ old('name', $budget->name) }}" />
                            @error('name')
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="date" id="start_date" name="start_date" placeholder="Masukan tanggal awal" value="{{ old('start_date', $budget->start_date) }}" />
                            @error('start_date')
                                <div class="text-danger text-sm mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="input-style-1">
                            ...
                            <input type="date" id="end_date" name="end_date" placeholder="Masukan tanggal akhir" value="{{ old('end_date', $budget->end_date) }}" />
                            @error('end_date')
                                <div class="text-danger text-sm mt-2">{{ $message }}</div>
                            @enderror
                        </div>
